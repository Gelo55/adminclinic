...
<head>
    ...
    <link rel="stylesheet" href="assets/css/shsdept.css">
...
<div class="box">
    <a href="">STEM</a>
    <footer><h1 class="stem">Science, Technology, Engineering, <br> and Mathematics</h1></footer>
</div>

<div class="box2">
    <a href="">ABM</a>
    <footer><h1 class="abm">Accountancy, Business <br> and Management</h1></footer>
</div>


<div class="box3">
    <a href="">HUMSS</a>
    <footer><h1 class="humss">Humanities and Social Sciences</h1></footer>
</div>


<div class="box4">
    <a href="">HE</a>
    <footer><h1 class="he">Home Economics</h1></footer>
</div>


<div class="box5">
    <a href="">ICT</a>
    <footer><h1 class="ict">Information and Communication Technology</h1></footer>
</div>


<div class="box6">
    <a href="">GAS</a>
    <footer><h1 class="gas">General Academic Strand</h1></footer>
</div>


<div class="box7">
    <a href="">PA</a>
    <footer><h1 class="pa">Performing Arts</h1></footer>
</div>
